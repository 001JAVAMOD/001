...
public class Sapphire_Ore {
    ...
    public static final RegistryObject<Block> EXAMPLE_SAPPHIRE_ORE = 
        registerBlock("example_sapphire_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE)
            .requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> EXAMPLE_DEEPSLATE_SAPPHIRE_ORE = 
        registerBlock("example_deepslate_sapphire_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE)
            .requiresCorrectToolForDrops()));
